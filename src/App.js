    ...
    <div className="App">
      <ThemeProvider theme={theme}>
        ...
        <div className={`${classes.grid} ${classes.bigSpace}`}>
          <Grid icon={<SecurityIcon style={{fill: "#4360A6", height:"125", width:"125"}}/>}  title="Asry" btnTitle="Myfeel " />
          <Grid icon={<EventNoteIcon style={{fill: "#449A76", height:"125", width:"125"}}/>} title="Aathif" btnTitle="Show me about Aathif"/>
        ...
        <div className={`${classes.grid} ${classes.littleSpace}`}>  
          ...
          <Grid icon={<AccessibilityIcon style={{fill: "#2EA09D", height:"125", width:"125"}}/>} title="Connected" btnTitle="Show me More"/>
        </div>
